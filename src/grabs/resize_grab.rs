...
bitflags::bitflags! {
    pub struct ResizeEdge: u32 {
        ...
        const TOP_RIGHT   = Self::TOP.bits | Self::BOTTOM.bits;
...
pub struct ResizeSurfaceGrab {
    start_data: PointerGrabStartData<Tsuki>,
    window: Window,
...
impl PointerGrab<Tsuki> for ResizeSurfaceGrab {
    fn motion(
        &mut self,
        data: &mut Tsuki,
    ...
    fn button(
        ...
        // Linux kernel's linux/input-event-codes.h file, e.g. BTN_LEFT
